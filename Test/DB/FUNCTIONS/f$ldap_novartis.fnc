CREATE OR REPLACE FUNCTION F$LDAP_NOVARTIS
(P_NTUSERID in VARCHAR2,
 P_NTPASSWORD IN  VARCHAR2) RETURN BOOLEAN as
   ldapHost1 VARCHAR2(100) := 'cds-test.eu.novartis.net';
  ...
  walletPassword VARCHAR2(30) := 'mgpzRvk5vWPqk#qsQzpcbSCNZ';
  --   walletPassword VARCHAR2(30) := 'Testing32!';
...
BEGIN
      ...
      --l_retval := dbms_ldap.open_ssl (l_session, 'file:C:\oracle\admin\APEXTRDHR\wallet\',walletPassword, 2);
