...
BEGIN
  ...
  WHEN c1%notfound;
    ...
    SET
      ...
      =(addworkingdays(decode(vnumberofpeople,0,0,vassignedhoursperorde)/ (vnumberofpeople *8), vstartdate))
      --CTS--=(addworkingdays(decode(vnumberofpeople,0,0,vassignedhoursperorde)/ (vnumberofpeople *7), vstartdate))
      where id=vid;
